...
export const avaxProvider = new ethers.JsonRpcProvider(avaxProviderrpc)
export const arbitrumProvider = new ethers.JsonRpcProvider(arbitrumProviderrpc)
export const ethereumProvider = new ethers.JsonRpcProvider(ethereumProviderrpc)
export const horizonProvider = new ethers.JsonRpcProvider(horizonProviderrpc)
export const maticProvider = new ethers.JsonRpcProvider(maticProviderrpc)
